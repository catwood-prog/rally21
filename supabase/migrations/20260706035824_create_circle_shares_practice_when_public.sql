...
begin
  ...
  -- privacy follows the circle: a public circle shares its practice to
  -- the library so others can start their own (never un-shared here —
  -- there's no "make private again" path today).
