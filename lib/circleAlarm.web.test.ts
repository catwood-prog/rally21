/**
 * AK1 job 3 — THE PLATFORM FENCE ON WEB, proven at the MODULE
 ...
 * a native module, it would prove nothing about a real web build. With
 * a fully functional fake underneath it, the ONLY thing that can keep the
 * feature off web is the Platform gate — so that is what this pins.
 *
...
describe('AK1 on web — the feature does not exist rather than existing-but-broken', () => {
